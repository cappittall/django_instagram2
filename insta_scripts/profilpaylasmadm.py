...
class ProfileShareDM:

    def __init__(self, username='', password='', message='',dm_target=''):
    ...
    def dmProfileShareStart(self, cookie_user_id, ip_port_proxy, auth_proxy, db_pigeonid, db_claim, db_deviceid,
        ...
        self.kullaniciuseridbul = self.dm_target

...
class DMReelMessage:
    ...
    def dmReelMessageStart(self, cookie_user_id, ip_port_proxy, auth_proxy, db_pigeonid, db_claim, db_deviceid,
    ...
    def DM_reelvideo_gonder(self):

        try:

            url = 'direct_v2/threads/broadcast/clip_share/'
            ...
            data = 'recipient_users=' + ddd81 + '&action=send_item&is_shh_mode=0&send_attribution=clips_viewer_explore_popular_major_unit&client_context=' + self.timeson12 + '&media_id=' + igtvvideopostid + '&device_id=' + self.androidid + '&mutation_token=' + self.timeson12 + '&_uuid=' + self.guid + '&offline_threading_id=' + self.timeson12

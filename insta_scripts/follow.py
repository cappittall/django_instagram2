...
class Follow:
    ...
    def followStart(self,cookie_user_id,ip_port_proxy,auth_proxy,db_pigeonid,db_claim,db_deviceid,db_phoneid,db_androidid,db_USER_AGENT,db_checksum,db_authorization,db_mid,db_userid,db_rur,db_guid,db_adid,db_waterfallid,db_mykey):
        ...
        try:
            ...
            if self.startControl == 0:
              ...
              self.follow_count_after = self.followcount()
              self.startControl = 1
            #print("b7")
            #self.hesabigor()
            print("b3")
            status = self.follow1()
            status = self.discover1()
            #status = self.followlog1()
            if status:
                  self.follow_count_later +=1
        ...
        print({'status':status,'message':self.error_message})
...
# follow1 ##########
                          ...
                          "batches": [
                            {
                              ...
                              "data": [
                                ...
                                },
                                {
                                  ...
                                  "extra": {
                                    "marker_id": 15335435,
                                    "instance_id": 1089215661,
                                    "sample_rate": 1,
                                    "time_since_boot_ms": 27755356,
                                    "duration_ns": 782181718,
                                    "action_id": 467,
                                    "marker_type": 1,
                                    ...
                                    "annotations": {
                                      ...
                                      "build_type": "prod",
                                      "last_app_start_trigger": "unknown",
                                      "last_app_start_type": "cold"
                                    },
                                    "annotations_bool": {
                                      "is_successful": True,
                                      "user_logged_in": True
                                    ...
                                    "annotations_int": {
                                      "duration_since_last_startup": 46269
                                    },
                                    "marker": "client_tti",
                                    "metadata": {
                                      "network_stats": {
                                        "network_type": "mobile",
                                        "network_subtype": "hspa+"
                                      },
                                      "cpu_stats": {
                                        "start_pri": -8,
                                        "stop_pri": -8,
                                ...
                                },
                                {
                                  ...
                                  "extra": {
                                    ...
                                    "nav_depth": 0,
                                    "nav_chain": "039:feed_timeline:1,UserDetailFragment:profile:2",
                                    "source_module": "feed_timeline",
                                    "dest_module": "profile",
                                    "seq": 1,
                                    "nav_time_taken": 1,
                                    "pk": self.userid,
                            ...
                            },
                            {
                              ...
                              "data": [
                                ...
                                },
                                {
                                  ...
                                  "extra": {
                                    "request_type": "create",
                                    "nav_events": "[{\"module\":\"feed_timeline\",\"click_point\":\"inferred_source\"},{\"module\":\"login\",\"click_point\":\"cold+start\"}]",
                                    "user_id": self.followuserid,
                                    "follow_status": "follow_requested",
                                    "entity_id": self.followuserid,
                                    "entity_type": "user",
                                    "entity_follow_status": "follow_requested",
                                    "nav_stack_depth": 0,
                                    "nav_stack": None,
                                    "click_point": "user_profile_header",
                                    "entry_trigger": "deep_link",
                                    "entry_module": "deep_link_util",
                                    "pk": self.userid,
                                    "release_channel": "prod",
                                    "radio_type": "mobile-hspa+"
                                  }
                                },
                                {
                                  ...
                                  "extra": {
                                    ...
                                    "profile_user_id": self.followuserid,
                                    "navstack": "[{\"module\":\"feed_timeline\",\"click_point\":\"inferred_source\"},{\"module\":\"login\",\"click_point\":\"cold+start\"}]",
                                    "media_id_attribution": None,
                                    "media_tracking_token_attribution": None,
                                    "hashtag_id": None,
                                    "hashtag_name": None,
                                    "click_point": "button_tray",
                                    "pk": self.userid,
                                    "release_channel": "prod",
                                    "radio_type": "mobile-hspa+"
                                  }
    ...
    def SendRequestlog1an(self, post=None):
        ...
        #response2 = scraper.post('https://graph.instagram.com/logging_client_events',data=post,proxies=self.proxyson2,  timeout=5)

        response2 = self.session.post('https://graph.instagram.com/logging_client_events', headers=headers, data=post,proxies=self.proxyson2,  timeout=5)
        print("Status33: ", response2.status_code)
        #print("Status33: ", response2.content)
        self.sonjson = response2.json()

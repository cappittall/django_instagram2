...
class DMIgTvMessage:
    ...
    def dmIgTvMessageStart(self, cookie_user_id, ip_port_proxy, auth_proxy, db_pigeonid, db_claim, db_deviceid,
    ...
    def medyaidbul(self):
        ...
        try:
            link1 = self.mediadlink + "?utm_medium=copy_link"
    ...
    def DM_igtvvideo_gonder(self):

        try:

            url = 'direct_v2/threads/broadcast/felix_share/'
            ...
            igtvvideopostid = self.media_id

            data = 'recipient_users=%5B%5B' + self.hesapidbul + '%5D%5D&action=send_item&is_shh_mode=0&send_attribution=feed_contextual_chain&client_context=' + self.timeson12 + '&media_id=' + igtvvideopostid + '&device_id=' + self.androidid + '&mutation_token=' + self.timeson12 + '&_uuid=' + self.guid + '&nav_chain=' + 'EaX%3Aexplore_popular%3A2%2C8v9%3Afeed_contextual_chain%3A3%2CDirectShareSheetFragment%3Adirect_reshare_sheet%3A4&offline_threading_id=' + self.timeson12

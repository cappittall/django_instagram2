...
class ProfileShareDMLink():

    def __init__(self,message='',dm_target='',link='',message2=''):
        ...
        self.kullaniciuseridbul = dm_target

        self.kullaniciuseridbulDM = ''
    ...
    def dmProfileShareLinkStart(self,cookie_user_id,db_mykey, dm_user, auth_proxy, ip_port_proxy, db_pigeonid, db_claim, db_deviceid, db_phoneid,
                      db_androidid, db_USER_AGENT, db_checksum, db_authorization, db_mid, db_userid, db_rur,
                      db_waterfallid, db_adid, db_guid):
        ...
        self.kullaniciuseridbulDM = dm_user
    ...
    def useridbuldm(self):

        try:

            link1 = "users/" + self.kullaniciuseridbulDM  + "/usernameinfo/?from_module=deep_link_util"
            ...
            self.hesapidbuldm = str(int(self.json1['user']['pk']))
            #print(self.hesapidbul)
    ...
    def DMprofilgonder(self):
        try:
            ...
            atmaca1 = '[[' + self.hesapidbuldm + ']]'
            ddd81 = urllib.parse.quote(atmaca1)

            data = 'profile_user_id=' + self.hesapidbul + '&recipient_users=' + ddd81 + '&action=send_item&is_shh_mode=0&send_attribution=profile&client_context=' + self.timeson12 + '&device_id=' + self.androidid + '&mutation_token=' + self.timeson12 + '&_uuid=' + self.guid + '&offline_threading_id=' + self.timeson12

            self.SendRequestloginsonrasitoplu2post2a(url,data)
    ...
    def DM2(self):
        ...
        try:
            ...
            self.timeson1 = str(int(self.timestamp3(True)) * 1.2)

            DM2 = "direct_v2/threads/broadcast/text/"

            al = '[[' + self.hesapidbuldm + ']]'
    ...
    def DMlink(self):
        ...
        try:
            ...
            self.hesapidDM = str(self.hesapidbuldm)
